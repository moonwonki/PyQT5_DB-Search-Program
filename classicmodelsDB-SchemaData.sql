...
(
	...
	CONSTRAINT		pk_payment
					PRIMARY KEY (customerId, checkNo),
...
(
	...
	shippedDate		DATE,
	status			ENUM('In Process', 'Shipped', 'Resolved', 'Disputed', 'On Hold', 'Cancelled')	NOT NULL,
	comments		TEXT,
	customerId		SMALLINT		NOT NULL,
	CONSTRAINT		pk_order
					PRIMARY KEY (orderNo),
	...
	CONSTRAINT 		chk_orderDate
					CHECK (orderDate >= '2001-01-01'),
	CONSTRAINT 		chk_orderDate_requiredDate
...
DROP VIEW IF EXISTS customersPerEmployee;
DROP VIEW IF EXISTS noOfCustomersPerEmployee;
...
FROM	offices O 
		...
		LEFT JOIN customers C ON e.employeeId = c.salesRepId;			/* 담당 고객이 없는 직원 포함 */

CREATE	VIEW noOfCustomersPerEmployee AS
SELECT	office, employee, jobTitle, COUNT(customer) AS noOfCustomers
...
SELECT	orderNo, productCode, name AS productName, productLine, 
		YEAR(orderDate) AS orderYear, 
		FLOOR(priceEach * quantity) AS orderValue
FROM	orders 
...
insert into employees(employeeId, lastName, firstName, extension, email, officeCode, managerId, jobTitle, birthDate) values 
(1002,'Murphy','Diane','x5800','dmurphy@classicmodelcars.com','1',NULL,'President','1962-01-10'),
(1056,'Patterson','Mary','x4611','marry.patterson@classicmodelcars.com','1',1002,'VP Sales','1974-01-20'),
(1076,'Firrelli','Jeff','x9273','jfirrelli@classicmodelcars.com','1',1002,'VP Marketing','1981-02-09'),
(1088,'Patterson','William','x4871','wpatterson@classicmodelcars.com','6',1056,'Sales Manager (APAC)','1984-02-19'),
(1102,'Bondur','Gerard','x5408','gbondur@classicmodelcars.com','4',1056,'Sales Manager (EMEA)','1987-03-08'),
(1143,'Bow','Anthony','x5428','anthony.bow@classicmodelcars.com','1',1056,'Sales Manager (NA)','1989-03-17'),
(1165,'Jennings','Leslie','x3291','ljennings@classicmodelcars.com','1',1143,'Sales Rep','2000-04-21'),
(1166,'Thompson','Leslie','x4065','lthompson@classicmodelcars.com','1',1143,'Sales Rep','2001-04-09'),
(1188,'Firrelli','Julie','x2173','jfirrelli@classicmodelcars.com','2',1143,'Sales Rep','2002-05-22'),
(1216,'Patterson','Steve','x4334','steve.patterson@classicmodelcars.com','2',1143,'Sales Rep','2003-05-06'),
(1286,'Tseng','Foon Yue','x2248','ftseng@classicmodelcars.com','3',1143,'Sales Rep','2000-06-22'),
(1323,'Vanauf','George','x4102','gvanauf@classicmodelcars.com','3',1143,'Sales Rep','2003-06-06'),
(1337,'Bondur','Loui','x6493','lbondur@classicmodelcars.com','4',1102,'Sales Rep','2001-07-17'),
(1370,'Hernandez','Gerard','x2028','ghernande@classicmodelcars.com','4',1102,'Sales Rep','2002-07-08'),
(1401,'Castillo','Pamela','x2759','pcastillo@classicmodelcars.com','4',1102,'Sales Rep','2003-08-26'),
(1501,'Bott','Larry','x2311','lbott@classicmodelcars.com','7',1102,'Sales Rep','2003-08-09'),
(1504,'Jones','Barry','x102','barry.jones@classicmodelcars.com','7',1102,'Sales Rep','2001-09-13'),
(1611,'Fixter','Andy','x101','afixter@classicmodelcars.com','6',1088,'Sales Rep','2002-09-25'),
(1612,'Marsh','Peter','x102','pmarsh@classicmodelcars.com','6',1088,'Sales Rep','2002-10-22'),
(1619,'King','Tom','x103','tking@classicmodelcars.com','6',1088,'Sales Rep','1995-10-06'),
(1621,'Nishi','Mami','x101','mnishi@classicmodelcars.com','5',1056,'Sales Rep','1997-11-11'),
(1625,'Kato','Yoshimi','x102','ykato@classicmodelcars.com','5',1621,'Sales Rep','2001-11-23'),
(1702,'Gerard','Martin','x2312','mgerard@classicmodelcars.com','4',1102,'Sales Rep','1999-12-25');


/*Data for the table `customers` */

insert into customers(customerId, name, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, postalCode, country, salesRepId, creditLimit) values 
...
insert into payments(customerId, checkNo, paymentDate, amount) values 
...
insert into productLines(productLine, description, htmlDescription, image) values 
